...
> Vendored from [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) (MIT — see LICENSE in this directory).
> **SettlePay precedence:** on any conflict, `docs/DESIGN-SYSTEM.md` and the `settlepay-design` skill win —
> use this skill for accessibility/UX rules, layout patterns and quality checklists, not to swap
> SettlePay's palette, type or radii. All paths below are relative to the repo root.
