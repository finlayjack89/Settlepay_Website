...
We work with small UK businesses that have outgrown bank transfers, cheques and card details read out over the phone: auctioneers, estate and lettings agents, sole traders and SMEs that want to get paid faster without changing how they like to work.

Our first live client is **[Lockdales Auctioneers](/work/lockdales-auctioneers/)**, where a bespoke payment portal replaced days of manual reconciliation after each sale.

Other situations we describe, such as a lettings business chasing rent or a merchant collecting overdue invoices, are illustrative examples used to explain how the model works. We'll never dress up a hypothetical as a real customer.

## Our Approach

Calm, honest and fast. We won't bury you in jargon or sell you something you don't need. If a simpler option suits you better, we'll say so.

Most setups go live in days, not weeks. If you have a deadline, an upcoming auction or a busy period coming up, an urgent service is available so you're ready in time.

We're clear about how things actually work, including the parts that take a day or two, like the time funds take to settle. You should never feel misled about your own cash flow.

## A Small, Founder-Led Operation

It's worth being straightforward about who you'd be dealing with. SettlePay is the trading name of Finlay Salisbury, a sole trader. It's a small, founder-led operation, not a faceless company with a call centre.

That's deliberate. It means you talk to the person doing the work, decisions happen quickly, and the responsibility for getting it right sits with one named individual. Personal and accountable, by design.

## Let's Talk

If any of this sounds like the problem you've been putting off, get in touch for a free, no-obligation consultation. We'll look at how you currently get paid and tell you honestly whether we can help.

Email **hello@settlepay.uk** or send a message through the website, and we'll take it from there.
